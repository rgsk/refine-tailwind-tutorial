import { GetManyResponse, useDelete, useMany, useNavigation } from '@pankod/refine-core';
import { ColumnDef, flexRender, useTable } from '@pankod/refine-react-table';
...
export const PostList: React.FC = () => {
  ...
  const categoryIds = useMemo(() => {
    return tableData?.data?.map((item) => item.category.id) ?? [];
  }, [tableData?.data]);
